...
<body>
    <div class="card">
        <h2>Hey there!</h2>
        <p>Welcome!</p>
        <p>This is a Test Webpage by Bismark</p>
        <p>Aspiring DevOps Engineer</p>
        <p>Jomacs DevOps Intern</p>
...
#Do not forget to post in the comment box for any kind of support that you may need in your installation process.
